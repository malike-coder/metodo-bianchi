...
const studies: StudyRef[] = [
  ...
  {
    area: 'Orden y Apego',
    title: 'The Relationship Between Object Attachment and Subjective Well-being',
    authors: 'Marie Kondo & Investigaciones de Apego Doméstico',
    year: '2016',
    evidence: 'moderada',
    findings: 'La sobrecarga de objetos no significativos (desorden residual) secuestra la atención visual activa y bloquea la manifestación de la propia identidad.',
    translation: 'Conservar y exponer únicamente objetos que tengan una utilidad clara o evoquen una memoria positiva.',
    citation: 'Kondo, M. / University of California (2016).',
  },
  {
